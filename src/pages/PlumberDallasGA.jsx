      ...
      <section className="bg-[#252525] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <p className="text-white/70 text-xl leading-relaxed mb-8 max-w-2xl">
            ...
            family-owned company based in Temple, GA — right in the heart of West Georgia — and we treat
            every customer like a neighbor. We show up on time, get it done right, and won't leave until you're satisfied.
          </p>
      ...
      <section className="py-20 bg-[#B08C47]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/90 text-lg leading-relaxed mb-8">
            Don't let a plumbing problem sit and get worse. If you're in {cityState} or anywhere in West Georgia, give DeFoor Plumbing a call at{' '}
