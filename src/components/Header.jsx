    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-[#B08C47] py-2">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between text-white text-sm">
          ...
          <a href="tel:7705620406" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
      ...
      <header className="fixed top-9 left-0 right-0 z-50 bg-[#252525]/95 backdrop-blur-md shadow-2xl py-3 transition-all duration-500">
        ...
        {/* Mobile Menu */}
        <div
          className={`lg:hidden absolute top-full left-0 right-0 bg-[#252525] backdrop-blur-lg transition-all duration-500 overflow-hidden ${mobileMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'
            }`}
        >
