...
export default function PlumberAustellGA() {
  return (
    <div className="pt-24">
      <SEOHead
      ...
      <section className="bg-[#252525] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <p className="text-white/70 text-xl leading-relaxed mb-8 max-w-2xl">
            ...
            family-owned company that cares about our customers and our communities. When you call us,
            you get real people, real experience, and real results — every time.
          </p>
