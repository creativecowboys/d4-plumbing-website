...
const city = 'Lithia Springs';
const cityState = 'Lithia Springs, GA';
...
export default function PlumberLithiaSpringsGA() {
  return (
    <div className="pt-24">
      <SEOHead
        title={`Plumber in ${cityState} | DeFoor Plumbing`}
        description={`Looking for a trusted plumber in ${cityState}? DeFoor Plumbing offers fast, reliable plumbing services including drain cleaning, water heater repair, leak detection, and more. Call (770) 562-0406.`}
      />
      <section className="bg-[#252525] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <p className="text-white/70 text-xl leading-relaxed mb-8 max-w-2xl">
            When you need a dependable plumber in {cityState}, DeFoor Plumbing is ready. We're a local,
            family-owned company that serves West Georgia communities like {city} with the same care and
            quality we'd give our own family. We show up, we fix it right, and we stand behind our work.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="tel:7705620406" className="inline-flex items-center justify-center gap-3 bg-[#B08C47] hover:bg-[#9a7a3d] text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg">
              <Phone className="w-5 h-5" />Call (770) 562-0406
            </a>
      ...
      <section className="py-20 bg-[#B08C47]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/90 text-lg leading-relaxed mb-8">
            ...
            <a href="tel:7705620406" className="font-bold underline hover:no-underline">(770) 562-0406</a>{' '}
            or reach out online for a free estimate. We're local, we're fast, and we're ready to help.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:7705620406" className="inline-flex items-center justify-center gap-3 bg-white hover:bg-[#F1EADA] text-[#B08C47] px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 shadow-lg">
              <Phone className="w-5 h-5" />Call (770) 562-0406
            </a>
