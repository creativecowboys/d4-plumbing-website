...
export default function PlumberBuchananGA() {
  return (
    <div className="pt-24">
      <SEOHead
      ...
      <section className="bg-[#252525] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <p className="text-white/70 text-xl leading-relaxed mb-8 max-w-2xl">
            When you need a dependable plumber in {cityState}, DeFoor Plumbing is the team to call.
            We're a local, family-owned company based in nearby Temple, GA, and we've built our reputation
            serving small communities like {city} with the same care and quality we'd give our own home.
          </p>
