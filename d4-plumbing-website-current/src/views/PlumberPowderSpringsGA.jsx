...
const city = 'Powder Springs';
const cityState = 'Powder Springs, GA';
...
export default function PlumberPowderSpringsGA() {
  return (
    <div className="pt-24">
      <SEOHead
      ...
      <section className="bg-[#252525] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <p className="text-white/70 text-xl leading-relaxed mb-8 max-w-2xl">
            ...
            family-owned company that has been serving West Georgia communities with quality plumbing work.
            We show up, we do the job right, and we keep you informed every step of the way.
          </p>
