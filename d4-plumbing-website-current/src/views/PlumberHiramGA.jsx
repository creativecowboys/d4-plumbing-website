...
export default function PlumberHiramGA() {
  return (
    <div className="pt-24">
      <SEOHead
      ...
      <section className="bg-[#252525] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <p className="text-white/70 text-xl leading-relaxed mb-8 max-w-2xl">
            ...
            family-owned company based in Temple, GA and we serve {cityState} and all of West Georgia.
            We treat every customer like a neighbor, show up on time, and get the job done right.
          </p>
