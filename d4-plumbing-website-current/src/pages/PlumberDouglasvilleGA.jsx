  ...
  return (
    <div className="pt-24 bg-[#F7F7F7]">
      <SEOHead
        ...
        ogTitle="Douglasville Plumber | D4 Plumbing | 35+ Years Local"
        ogDescription="Trusted Douglasville plumber serving Chapel Hill, Mt. Carmel, Arbor Place & all of Douglas County since 1979. Free estimates, same-day service."
        ogUrl="https://d4plumbing.com/plumber-douglasville-ga/"
        ogType="website"
        ogImage="https://d4plumbing.com/images/douglasville-plumber.jpg"
      ...
      <section className="py-16 bg-[#252525] text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <Link to="/plumber-bremen-ga" className="hover:text-[#B08C47] transition-colors border-b border-white/10 pb-1">
              Bremen plumber
            </Link>
          </div>
        </div>
