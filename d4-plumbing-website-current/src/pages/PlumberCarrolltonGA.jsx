  ...
  return (
    <div className="pt-24 bg-[#F7F7F7]">
      <SEOHead
        ...
        ogTitle="Carrollton GA Plumber | D4 Plumbing | 35+ Years Local"
        ogDescription="Trusted Carrollton, GA plumber. Family-owned since 1979. Same-day service to Carrollton, UWG area & all of Carroll County."
        ogUrl="https://d4plumbing.com/plumber-carrollton-ga/"
        ogType="website"
        ogImage="https://d4plumbing.com/images/carrollton-plumber.jpg"
